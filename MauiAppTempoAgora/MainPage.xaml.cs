using System.Diagnostics; // Usado para registrar informações no console de depuração
using MauiAppTempoAgora.Models; // Importa os modelos de dados da aplicação
using MauiAppTempoAgora.Services; // Importa os serviços da aplicação
